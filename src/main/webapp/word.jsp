...
<div class="container" id="word">
    <div>
        <span class="h3">${word.wordName}</span>
        <span class="h5">${word.wordPron}</span>
    </div>
    <hr>
    <div class="row" style="">
        <div class="col-md-10">
                    ...
                    <div class="h5">
                        <ul style="-webkit-padding-start: 10px">
                            <span  style="margin-left: 20px">
                               <span style="margin-top:10px" class="badge">${word.wordSimilar}</span>
                            </span>
                        </ul>
                    </div>
                </div>
